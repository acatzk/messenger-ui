...
export default function Layout ({ children }) {
  ...
  return (
    <div className="flex flex-row bg-white w-full h-screen">
      ...
      {/* Chat files `LEFT` */}
      <div className="w-60 md:w-left-side flex-none">
...
function Dropdown ({ title, isOpen, list }) {
...
function AphabetIcon () {
  return (
    <svg viewBox="0 0 36 36" class="a8c37x1j ms05siws hwsy1cff b7h9ocf4" height="24" width="24">
